...
export default class RunnerLevel extends Level {
    ...
    */
    ...
    setupAssets() {
        ...
        this.assets.addSound('gameLostSound', '/assets/sounds/game-lost.wav', { volume: 0.001 });
        this.assets.addSound('gotCoinSound', '/assets/sounds/coin_going_into_pot.wav', { volume: 0.0015 });
        ...
        this.assets.addSound('zappingSound', '/assets/sounds/Zapping_Scam.wav', { volume: 0.0005 });
